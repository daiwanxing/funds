...
<template>
  ...
  >
    <div
      class="bg-white rounded-15px w-326px text-center"
    ...
    >
      ...
      <div class="py-3 flex justify-center gap-2">
        <button
          class="text-xs border border-green-500 text-green-600 rounded px-2 py-1 cursor-pointer bg-white"
          @click="close"
        >
          打赏好了
        </button>
        <button
          class="text-xs border border-gray-300 rounded px-2 py-1 cursor-pointer bg-white"
          @click="close"
        >
          下次一定
        </button>
