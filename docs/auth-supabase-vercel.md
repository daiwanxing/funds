...
- 当前系统未对外开放 `reset-password` 前端路由
- 因此本设计文档保留“找回密码”作为能力预留，但不再把它视为当前对外可用流程
...
- 当前系统未开放对应前端页面，因此这条链路暂不作为正式用户流程开放
- 如后续重新启用，需要补齐实际可访问的前端回调页和文档说明
